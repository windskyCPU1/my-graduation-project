...
class YoloNode(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("yolo_encoding", "rgb8")
        ...
        self.get_logger().info("Loading model666..."),
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Loading model333..."),
    ...
    # 设置环境变量
        import os
        os.environ["ULTRALYTICS_NO_UPDATE_CHECK"] = "1"
        os.environ["ULTRALYTICS_TELEMETRY_ENABLED"] = "0"
    ...
    # 切换工作目录
        ...
        try:
            ...
            self.get_logger().info(f"Restored working directory to: {original_cwd}")
