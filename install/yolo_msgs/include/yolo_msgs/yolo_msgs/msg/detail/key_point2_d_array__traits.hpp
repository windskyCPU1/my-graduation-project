...
// Member 'data'
#include "yolo_msgs/msg/detail/key_point2_d__traits.hpp"
...
inline void to_yaml(
  const yolo_msgs::msg::KeyPoint2DArray & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const yolo_msgs::msg::KeyPoint2DArray & msg)
{
