...
{
  const auto & item = *reinterpret_cast<const yolo_msgs::msg::Detection *>(
    get_const_function__DetectionArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<yolo_msgs::msg::Detection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<yolo_msgs::msg::Detection *>(
    get_function__DetectionArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const yolo_msgs::msg::Detection *>(untyped_value);
  item = value;
}
