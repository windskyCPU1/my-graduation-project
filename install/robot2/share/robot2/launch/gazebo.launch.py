...
def generate_launch_description():
    ...
    urdf_tutorial_path = get_package_share_directory('robot2')
    default_model_path1 = urdf_tutorial_path + '/urdf/robot2.urdf.xacro'
...
# 声明 use_sim_time 参数
    ...
    cmd_vel_relay = launch_ros.actions.Node(
                package='topic_tools',
                executable='relay',
                name='cmd_vel_relay',
